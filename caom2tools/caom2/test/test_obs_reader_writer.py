...
def compare_observations(self, expected, actual, version):
    ...
    if version == 21:
        compare_requirements(self, expected.requirements, actual.requirements)
...
def compare_target_position(self, expected, actual):
    ...
    compare_point(self, expected.coordinates, actual.coordinates)
...
def compare_members(self, expected, actual):
    ...
    for expected_member, actual_member in zip(expected, actual):
        compare_observation_uri(self, expected_member, actual_member)
...
def compare_planes(self, expected, actual, version):
    ...
    for key in expected:
        ...
        compare_provenance(self, expected_plane.provenance,
...
def compare_provenance(self, expected, actual):
    ...
    compare_inputs(self, expected.inputs, actual.inputs)
...
def compare_parts(self, expected, actual, version):
    ...
    for key in expected:
        ...
        compare_chunks(self, expected_part.chunks, actual_part.chunks)
...
def compare_observable_axis(self, expected, actual):
    ...
    self.assertIsNotNone(expected)
    self.assertIsNotNone(actual)
    compare_slice(self, expected.dependent, actual.dependent)
    compare_slice(self, expected.independent, actual.independent)
...
def compare_spatial_wcs(self, expected, actual):
    ...
    self.assertIsNotNone(expected)
    self.assertIsNotNone(actual)
    compare_coord_axis2d(self, expected.axis, actual.axis)
    self.assertEqual(expected.coordsys, actual.coordsys)
    self.assertEqual(expected.equinox, actual.equinox)
...
def compare_spectral_wcs(self, expected, actual):
    ...
    self.assertIsNotNone(expected)
    self.assertIsNotNone(actual)
    compare_coord_axis1d(self, expected.axis, actual.axis)
...
def compare_coord2d(self, expected, actual):
    if expected is None:
        ...
        return
    self.assertIsNotNone(actual)
    compare_ref_coord(self, expected.coord1, actual.coord1)
    compare_ref_coord(self, expected.coord2, actual.coord2)
...
def compare_coord_axis1d(self, expected, actual):
    if expected is None:
        ...
        return
    self.assertIsNotNone(actual)
    compare_coord_error(self, expected.error, actual.error)
    compare_coord_range1d(self, expected.range, actual.range)
    compare_coord_bounds1d(self, expected.bounds, actual.bounds)
    compare_coord_function1d(self, expected.function, actual.function)
...
def compare_coord_axis2d(self, expected, actual):
    ...
    compare_axis(self, expected.axis1, actual.axis1)
    compare_axis(self, expected.axis2, actual.axis2)
    compare_coord_error(self, expected.error1, actual.error1)
    compare_coord_error(self, expected.error2, actual.error2)
    compare_coord_range2d(self, expected.range, actual.range)
    compare_coord_bounds2d(self, expected.bounds, actual.bounds)
    compare_coord_function2d(self, expected.function, actual.function)
...
def compare_coord_bounds1d(self, expected, actual):
    ...
    for expected_range, actual_range in zip(expected.samples, actual.samples):
        compare_coord_range1d(self, expected_range, actual_range)
...
def compare_coord_circle2d(self, expected, actual):
    ...
    compare_value_coord2d(self, expected.center, actual.center)
...
def compare_coord_function2d(self, expected, actual):
    ...
    compare_dimension2d(self, expected.dimension, actual.dimension)
    compare_coord2d(self, expected.ref_coord, actual.ref_coord)
...
def compare_coord_polygon2d(self, expected, actual):
    ...
    for expected_coord_2d, actual_coord_2d in zip(expected.vertices,
                                                  actual.vertices):
        compare_value_coord2d(self, expected_coord_2d, actual_coord_2d)
...
def compare_coord_range1d(self, expected, actual):
    if expected is None:
        ...
        return
    self.assertIsNotNone(actual)
    compare_ref_coord(self, expected.start, actual.start)
    compare_ref_coord(self, expected.end, actual.end)
...
def compare_coord_range2d(self, expected, actual):
    ...
    compare_coord2d(self, expected.start, actual.start)
    compare_coord2d(self, expected.end, actual.end)
...
def compare_slice(self, expected, actual):
    ...
    compare_axis(self, expected.axis, actual.axis)
