...
from caom2 import DataProductType, CalibrationLevel, PlaneURI, DataQuality, ProductType, ReleaseType
import logging
import os
import sys
...
class FitsParser(object):
    ...
    def augment_observation(self, observation, artifact_uri):
        ...
        :param artifact_uri:
        """
        self.logger.debug('Begin CAOM2 observation augmentation for {} based on URI {}.'.format(self.filename, artifact_uri))
...
class WcsParser(object):
    ...
    def augment_temporal(self, chunk):
        ...
        chunk.time.timesys = str(self.header.get('TIMESYS'))
