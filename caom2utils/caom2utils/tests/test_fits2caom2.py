...
#     #
#     # what are the rules for the keys:
#     # has a . - a config keyword
#     # all upper case - a FITS keyword
#
#     hdr1 = fits.Header()
#     hdr2 = fits.Header()
#     test_parser = FitsParser(src=[hdr1, hdr2])
...
#
#     test_parser = update_fits_headers(test_parser, test_config, defaults=None,
#                                       overrides=None)
...
#     test_config = def_config.copy()
#     test_parser = update_fits_headers(test_parser, test_config, test_defaults,
#                                       overrides=None)
#
...
#         # test_parser = update_fits_headers(test_parser, test_config, test_defaults,
#         #                                   test_overrides)
#         # assert test_parser.config['Observation.type'] == 'OVERRIDE'


TEST_OVERRIDES = {'sequenceNumber': '1709071',
                  'obs.intent': 'science',
